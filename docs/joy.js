 ...
 * The MIT License (MIT)
 *
 * This file is derived from https://github.com/bobboteck/JoyStick, which
 * is also an MIT project. 
 */
...
var JoyStick = (function(container, parameters, callback)
{
    ...
    function keepSendingWhenPressed()
    {
    ...
    {
        pressed = 1;
        pressedInterval = setInterval(keepSendingWhenPressed, 100);
