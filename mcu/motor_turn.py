...
class MotorTurn: 
    ...
    # borrowed from the post here at: https://www.upesy.com/blogs/tutorials/esp32-servo-motor-sg90-on-micropython
    __servo_pwm_freq = 50
    ...
    def update_settings(self, servo_pwm_freq, min_u10_duty, max_u10_duty, min_angle, max_angle, pin=25):
